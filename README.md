...
This package manages the computational environment for the **Text as Data** course at the University of Pittsburgh School of Education. It automatically installs necessary dependencies (like `tidyverse`, `quanteda`, and `janitor`) and provides helper functions for project management.
...
*Note: If asked to update packages, you can select `1` (All) or `3` (None). If asked to compile packages from source, you can typically type "No".*
